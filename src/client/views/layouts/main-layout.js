...
const { ScrollActionTo, ScrollActionTop, ScrollEventType, SCROLL_THRESHOLD } = require('../../data/scroll');

const { changeLangPath, toggleQueryParameter } = require('../../../utils');
const { navigateHandler } = require('../../utils');

const { context } = require('../../globals');
const { DEFAULT_LANGUAGE, LANGUAGES } = require('../../../globals');
